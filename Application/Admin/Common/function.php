...
function get_status_title($status = null){
    ...
    switch ($status){
        case -1 : return    L('L_STATUS_DELETED');   break;
        case 0  : return    L('L_STATUS_DISABLE');     break;
        case 1  : return    L('L_STATUS_ENABLE');     break;
        case 2  : return    L('L_STATUS_CHECKED');   break;
...
function show_status_op($status) {
    switch ($status){
        ...
        // default : return    false;      break;
        case 0  : return    L('L_BTN_OPEN');      break;
        case 1  : return    L('L_BTN_CLOSE');     break;
        case 2  : return    L('L_BTN_CHECK');     break;
        default : return    false;      break;
    }
}
 ...
 *
 */
function int_to_string(&$data,$map=array('status'=>array(1=>'Enable',-1=>'Deleted',0=>'Disabled',2=>'In Audit',3=>'The draft'))) {
