...
class AttributeModel extends Model {
    ...
    protected function _initialize()
    {
        ...
        $this->_validate = array(
            array('name', 'require', L('L_MODEL_ATTR_1'), self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
            array('name', '/^[a-zA-Z][\w_]{1,29}$/', L('L_MODEL_ATTR_2'), self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
            array('name', 'checkName', L('L_MODEL_ATTR_3'), self::MUST_VALIDATE, 'callback', self::MODEL_BOTH),
            array('field', 'require', L('L_MODEL_ATTR_4'), self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
            array('field', '1,100', L('L_MODEL_ATTR_5'), self::VALUE_VALIDATE, 'length', self::MODEL_BOTH),
            array('title', '1,100', L('L_MODEL_ATTR_6'), self::VALUE_VALIDATE, 'length', self::MODEL_BOTH),
            array('remark', '1,100', L('L_MODEL_ATTR_7'), self::VALUE_VALIDATE, 'length', self::MODEL_BOTH),
            array('model_id', 'require', L('L_MODEL_ATTR_8'), self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        );
    }
    /* 自动完成规则 */
