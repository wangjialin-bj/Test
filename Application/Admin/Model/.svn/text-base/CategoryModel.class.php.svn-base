...
class CategoryModel extends Model{
    ...
    protected function _initialize()
    {
        ...
        $this->_validate = array(
            array('name', 'require', L('L_MODEL_CATEGORY_1'), self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
            array('name', '', L('L_MODEL_CATEGORY_2'), self::VALUE_VALIDATE, 'unique', self::MODEL_BOTH),
            array('title', 'require', L('L_MODEL_CATEGORY_3'), self::MUST_VALIDATE , 'regex', self::MODEL_BOTH),
            array('meta_title', '1,50', L('L_MODEL_CATEGORY_4'), self::VALUE_VALIDATE , 'length', self::MODEL_BOTH),
            array('keywords', '1,255', L('L_MODEL_CATEGORY_5'), self::VALUE_VALIDATE , 'length', self::MODEL_BOTH),
            array('meta_title', '1,255', L('L_MODEL_CATEGORY_6'), self::VALUE_VALIDATE , 'length', self::MODEL_BOTH),
        );
    }
